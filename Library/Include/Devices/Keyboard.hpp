...
#ifndef MST_INPUT_KEYBOARD_HPP
#define MST_INPUT_KEYBOARD_HPP
...
namespace MST
{
  ...
  private:
    //***********************************************************************//
    //-----------------------------------------------------------------------//
    // This member is the pointer to DirectInput's keyboard interface device
